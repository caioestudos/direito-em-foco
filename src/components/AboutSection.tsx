        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative animate-fade-in order-2 lg:order-1">
            <div className="relative">
              ...
              <img
                ...
                className="relative rounded-2xl shadow-elegant w-full h-[500px] object-cover object-top"
              />
            </div>
            {/* Credentials Card */}
          ...
          <div className="space-y-8 animate-fade-in delay-200 order-1 lg:order-2">
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                Natural de Juazeiro do Norte, no coração do Cariri cearense, construí minha 
                carreira com um propósito claro: <strong className="text-foreground">defender 
